...
- **hardware.nix**: AMD GPU with amdgpu driver early loading, hardware acceleration, Bluetooth with power-on-boot enabled, firmware updates, NFS mount (TrueNAS Kopia at 192.168.0.55:/mnt/main-pool/kopia with automount and nofail options)
...
- TrueNAS Kopia share mounted at /mnt/truenas/kopia (Kopia backups, read-write, automounted on access, mac-backup mount removed)
