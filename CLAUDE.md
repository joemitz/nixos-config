...
- Server address: https://127.0.0.1:51515 with TLS certificate auto-generation and built-in web UI (`--ui` flag)
- Authentication: None (local-only server, no credentials needed)
